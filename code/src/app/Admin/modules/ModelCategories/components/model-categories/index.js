...
function ModelCategories(props) {
    ...
    const {modelCategoryList, listLoading} = useSelector(
        state => ({
            modelCategoryList: state.modelCategory.entities,
        ...
        <>
            ...
            <BlockUi tag="div" blocking={listLoading} color="#147b82">
                <BlockUi tag="div" blocking={loaderState} color="#147b82">
                    ...
                    {selectedCategory.length <= 0 && !searchDataCalled && (
                        // <Card className="example example-compact mb-4">
                        //   <CardBody>
                        <Row>
                            <div>
                            ...
                            <Col xl={12} md={12} sm={12} lg={12}>
                                <div>
                                    <h3 className={"text-center mt-6"}>No results found</h3>
                                </div>
                            </Col>
                        </Row>
                        //   </CardBody>
...
export default connect(mapStateToProps, auth.actions)(ModelCategories);
