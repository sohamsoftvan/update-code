...
const BannerImageUIContext = createContext();

export function useUsersUIContext() {
    return useContext(BannerImageUIContext);
}

export const ExampleUIConsumer = BannerImageUIContext.Consumer;
...
export function UsersUIProvider({usersUIEvents , children}) {
    ...
    return <BannerImageUIContext.Provider value={value}>{children}</BannerImageUIContext.Provider>;
}
