            ...
            <div className={`card card-custom ${className}`}>
                ...
                <div className="card-body pt-2">
                    <div className="d-flex align-items-center mb-10">
                        ...
                        <label
                            className="checkbox checkbox-lg checkbox-light-success checkbox-single flex-shrink-0 m-0 mx-4">
                    ...
                    <div className="d-flex align-items-center mb-10">
                        ...
                        <label
                            className="checkbox checkbox-lg checkbox-light-primary checkbox-single flex-shrink-0 m-0 mx-4">
                    ...
                    <div className="d-flex align-items-center mb-10">
                        ...
                        <label
                            className="checkbox checkbox-lg checkbox-light-warning checkbox-single flex-shrink-0 m-0 mx-4">
                    ...
                    <div className="d-flex align-items-center mb-10">
                        ...
                        <label
                            className="checkbox checkbox-lg checkbox-light-info checkbox-single flex-shrink-0 m-0 mx-4">
                            <input type="checkbox" value="1" onChange={() => {
                            }}/>
                            <span></span>
                        </label>
                    ...
                    <div className="d-flex align-items-center mb-2">
                        ...
                        <label
                            className="checkbox checkbox-lg checkbox-light-danger checkbox-single flex-shrink-0 m-0 mx-4">
                            <input type="checkbox" value="1" onChange={() => {
                            }}/>
                            <span></span>
                        </label>
