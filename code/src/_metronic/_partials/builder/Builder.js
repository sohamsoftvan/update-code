                                ...
                                <div className="card-footer">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-9">
                                            <CustomizedButtons title="Preview" icon={<i className="la la-eye"/>} submit={handleSubmit} className={`font-weight-bold mr-2`} />
                                            {" "}
                                            <CustomizedButtons title="Reset" icon={<i className="la la-recycle"/>} submit={handleReset} className={`font-weight-bold mr-2`} />
